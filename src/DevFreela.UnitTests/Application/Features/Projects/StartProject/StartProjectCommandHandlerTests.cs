...
namespace DevFreela.UnitTests.Application.Features.Projects.StartProject
{
    public class StartProjectCommandHandlerTests
    {
        [Fact]
        public async Task ProjectExists_Start_Success_NSubstitute()
        {
            // Arrange
            ...
            var command = FakeDataHelper.CreateFakeStartProjectCommand();
            var handler = new StartProjectCommandHandler(unitOfWork);
        ...
        [Fact]
        public async Task ProjectDoesNotExist_Start_Failure_NSubstitute()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProjectExists_Start_Success_Moq()
        {
            // Arrange
            var project = FakeDataHelper.CreateFakeProject();
        ...
        [Fact]
        public async Task ProjectDoesNotExist_Start_Failure_Moq()
        {
            // Arrange
            var repository = Mock.Of<IProjectRepository>(r =>
